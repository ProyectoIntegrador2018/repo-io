  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested repository" do
        repository = Repository.create! valid_attributes
        put :update, params: {id: repository.to_param, repository: new_attributes}, session: valid_session
        repository.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        repository = Repository.create! valid_attributes
        put :update, params: {id: repository.to_param, repository: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
